    ...
    if (isFallback) {
      ...
      try {
        ...
        const unsubUser = onSnapshot(userRef, (snap) => {
          ...
          console.warn("User sync failed, falling back to LocalStorage:", err);
          setIsFallback(true);
        });
